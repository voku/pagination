 ...
 * @internal
 */
final class PaginatorStrictTest extends TestCase
{
    /**
     * @var Paginator
     */
    ...
    public function testPageLinks()
    {
        ...
        static::assertSame(
            '<ul class="pagination " data-pagination-current="1" data-pagination-prev="false" data-pagination-next="2" data-pagination-length="17"><li class="pagination--start"><span>&laquo;</span></li><li class="active"><span>1</span></li><li><a href="?pid=1&pager=2">2</a></li><li><a href="?pid=1&pager=3">3</a></li><li><a href="?pid=1&pager=4">4</a></li><li><a href="?pid=1&pager=5">5</a></li><li><a href="?pid=1&pager=6">6</a></li><li><a href="?pid=1&pager=7">7</a></li><li><span>&hellip;</span></li><li><a href="?pid=1&pager=16">16</a></li><li><a href="?pid=1&pager=17">17</a></li><li class="pagination--end"><a href="?pid=1&pager=2">&raquo;</a></li></ul>',
    ...
    {
        static::assertSame(' LIMIT 0,6', $this->paginator->get_limit());

        $this->paginator->set_pageIdentifierFromGet(4);

        static::assertSame(' LIMIT 18,6', $this->paginator->get_limit());
    }

    public function testGetSQLLimitRaw()
    {
        static::assertSame([0, 6], $this->paginator->get_limit_raw());

        $this->paginator->set_pageIdentifierFromGet(4);

        static::assertSame([18, 6], $this->paginator->get_limit_raw());
    }
}
